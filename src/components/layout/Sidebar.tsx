      ...
      {!collapsed && (
        ...
        >
          <span className="block text-[15px] font-bold leading-none tracking-tight whitespace-nowrap text-white">
            Kairo<span className="text-[#22C55E]">Hub</span>
          </span>
            ...
            return (
              <Link key={item.href} to={item.href}>
                <div
                  ...
                  style={{ background: 'linear-gradient(135deg, rgba(34,197,94,0.15) 0%, rgba(31,107,74,0.10) 100%)', border: '1px solid rgba(34,197,94,0.25)' }}
                >
                  <item.icon className="w-[15px] h-[15px] flex-shrink-0 text-[#22C55E]" />
                  {!collapsed && (
                    <>
                      <span className="whitespace-nowrap text-[#34D399] font-medium flex-1">
                        {item.label}
                      </span>
                      <span
                ...
                <div className="space-y-1">
                  ...
                  <div className="h-1 rounded-full overflow-hidden" style={{ background: '#1e2535' }}>
                    <div
                      ...
                      style={{
                        width: `${aiPct}%`,
                        background: aiPct >= 90 ? '#ef4444' : aiPct >= 70 ? '#F5A623' : 'linear-gradient(90deg, #22C55E, #2F8F63)',
                      }}
                    />
                  </div>
                </div>
