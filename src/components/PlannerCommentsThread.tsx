    ...
    <div className="rounded-xl overflow-hidden border border-[#e8e8e8]">
      ...
      <div className="px-3 py-2.5 flex gap-2 border-t bg-white border-[#e8e8e8]">
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-lg text-[11px] font-semibold disabled:opacity-60 transition-colors flex-shrink-0 bg-blue-700 hover:bg-blue-800 disabled:bg-blue-600"
          style={{ color: '#ffffff' }}
        >
          Enviar
        </button>
