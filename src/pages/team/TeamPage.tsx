      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md flex flex-col overflow-hidden">
        ...
        <div className="p-5 space-y-3">
          ...
          <p className="text-[10px] text-[#94a3b8]">
            O link do portal já está incluído na mensagem. Edite à vontade antes de enviar.
          </p>
        </div>
    ...
    <>
      ...
      >
        ...
        <div className="flex gap-1.5 pt-1 border-t border-[#f1f5f9]" onClick={e => e.stopPropagation()}>
          ...
          {/* WhatsApp — só aparece se tiver número */}
          {member.whatsapp && (
            <button
              onClick={() => setShowWhatsApp(true)}
              title="Enviar link do portal via WhatsApp"
              className="flex items-center gap-1 px-2 py-1 rounded-lg text-[11px] text-[#25D366] hover:bg-[#f0fdf4] transition-colors font-medium"
            >
